...
function pop(){
		...
		<div class="container" style="padding-top:10px;">
			<br />
			<h3 align="center"><a href="#">E-LOBSTORE</a></h3>
			<br />
			...
			<div id="popover_content_wrapper" style="display: none">
				...
				<?php 
				 $output3="";
				     if(isset($_SESSION['mail'])){					
						 $output3.='
					<a href="profile.php" class="btn btn-primary" id="check_out_cart">
					<span class="glyphicon glyphicon-shopping-cart"></span> Check out
					</a>';
					echo $output3;
					 }else{
						 $output3.='
					<a href="#" class="btn btn-primary" id="check_out_cart" onclick="golog()">
					<span class="glyphicon glyphicon-shopping-cart"></span> Check out
					</a>';
					echo $output3;
					 }
			...
			<script>
			function golog(){
			                  if(window.confirm('Please login into your account for checkout'))
							  {
...
{   $id1=$_GET['id'];
	$query = "SELECT * FROM tbl_product WHERE category='$id1';";
