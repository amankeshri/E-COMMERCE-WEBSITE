...
<input type="text" name="search_text" id="search_text" action="cat_grocery.php" placeholder="What you are looking for?" class="form-control" />			
...
{
	$query = "SELECT * FROM tbl_product WHERE category='grocery';";
