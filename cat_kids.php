...
<input type="text" name="search_text" id="search_text" action="cat_kids.php" placeholder="What you are looking for?" class="form-control" />			
...
{
	$query = "SELECT * FROM tbl_product WHERE category='kids';";
